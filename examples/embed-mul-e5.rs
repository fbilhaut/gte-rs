...
fn main() -> gte::util::result::Result<()> {        
    ...
    const MODEL_PATH: &str = "models/multilingual-e5-base/onnx/model.onnx";
    ...
    let q1_p1 = gte::util::test::distance(&outputs, 0, 2); dbg!(q1_p1);
    let q1_p2 = gte::util::test::distance(&outputs, 0, 3); dbg!(q1_p2);
    let q2_p1 = gte::util::test::distance(&outputs, 1, 2); dbg!(q2_p1);
    let q2_p2 = gte::util::test::distance(&outputs, 1, 3); dbg!(q2_p2);
